...
class Embedding:
    ...
    def replace_embeddings(original_embedding, new_embedding):
        '''
...
if __name__ == '__main__' :
    ...
    embedding = Embedding(word2index,index2word,index2embedding, blacklist_threshold = 0)

    # # Load counterfitted embeddings
    # print('Loading counter-fitted vectors...')
    # start_time = time.time()
    # COUNTERFITTED_GLOVE_FILENAME = 'data/fasttext-counter-fitted-vectors.txt'
